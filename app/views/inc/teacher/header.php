        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<?php echo URLROOT . '/users/teacher'; ?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>


                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i>My Class <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="<?php echo URLROOT . "/users/insert"; ?>">All classes</a>
                            </li>
                            <li>
                                <a href="<?php echo URLROOT . "/users/update"; ?>">All students</a>
                            </li>
                            <li>
                                <a href="<?php echo URLROOT . "/users/delete"; ?>">...</a>
                            </li>
                        </ul>
