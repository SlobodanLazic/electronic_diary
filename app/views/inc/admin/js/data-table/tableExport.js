    ...
    tableExport: function (options) {
      ...
      */
      ...
      function parseNumber (value) {
        value = value || "0";
        value = replaceAll(value, defaults.numbers.php.thousandsSeparator, '');
        value = replaceAll(value, defaults.numbers.php.decimalMark, '.');
      ...
      function parseString (cell, rowIndex, colIndex) {
        ...
        if ( cell !== null ) {
          ...
          if ( defaults.phpContent === true ) {
            result = $.trim(htmlData);
          }
          else if ( htmlData && htmlData != '' ) {
            var text   = htmlData.replace(/\n/g, '\u2028').replace(/<br\s*[\/]?>/gi, '\u2060');
            var obj    = $('<div/>').php(text).contents();
            var number = false;
            text       = '';
            ...
            else if ( defaults.numbers.php.decimalMark != defaults.numbers.output.decimalMark ||
              defaults.numbers.php.thousandsSeparator != defaults.numbers.output.thousandsSeparator ) {
              number = parseNumber(result);
