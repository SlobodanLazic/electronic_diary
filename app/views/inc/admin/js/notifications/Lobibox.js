...
//------------------------------------------------------------------------------
    ...
    var LobiboxBase = {
        ...
        _setContent: function (msg) {
            var me = this;
            me.$el.find('.lobibox-body').php(msg);
            return me;
        },
...
//------------------------------------------------------------------------------
        ...
        setTitle: function (title) {
            return this.$el.find('.lobibox-title').php(title);
        },
         ...
         */
        getTitle: function () {
            return this.$el.find('.lobibox-title').php();
        },
...
//------------------------------------------------------------------------------
    ...
    LobiboxProgress.prototype = $.extend({}, LobiboxBase, {
        ...
        setProgress: function (progress) {
            ...
            me.$el.find('[data-role="progress-text"]').php(progress.toFixed(1) + "%");
            return me;
        },
...
//------------------------------------------------------------------------------
    ...
    LobiboxWindow.prototype = $.extend({}, LobiboxBase, {
        ...
        setContent: function (content) {
            ...
            me.$el.find('.lobibox-body').php('').append(content);
            return me;
        },
        /**
