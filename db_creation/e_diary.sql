...
(1, 'administrator', 'access only the configuration page (administration of the application):\r\nto add, delete and change users\r\nto assign roles to users\r\nto add, delete and change objects and departments\r\nto add, fold and change the timetable\r\nto manage the parenting section'),
(2, 'director', 'to have access to statistics on the success of the class by subject\r\nto have access to performance statistics for subjects at the school level'),
(3, 'teacher', 'can have 1 class and access only to 1 class,can edit grades,can accept or deny parent requests,can access messaging system,can access schedule'),
(4, 'parent', 'has access to and evaluations only for his child,has access to the part of the application where he will schedule the arrival at the open door,can acess messaging system,have access to the parental information section');
